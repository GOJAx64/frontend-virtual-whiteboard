...
export const ModalUpdateActivity = () => {
    ...
    const handleSubmit = () => {
        ...
        updateActivity({ id: activity.id, title, description, dueDate });
    };

    const handleCloseModal = () => {
        setShowModalUpdateActivity(false);
    };
    ...
    return (
        <>
            <div className="ml-48 justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                <div className="relative w-full max-w-4xl border border-slate-600 rounded-xl">
                    {/*content*/}
                                ...
                                <div className='flex mt-2'>
                                    <div className='w-3/4'>
                                        ...
                                        <input
                                            id="title"
                                            type="text"
                                            className="w-full text-sm p-2 border rounded bg-slate-50 text-slate-900 border-slate-300"
                                            name='title'
                                            value={ title }
